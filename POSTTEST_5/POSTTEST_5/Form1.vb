Public Class Form1
	...
	Private Sub btnSimpan_Click(sender As Object, e As EventArgs) Handles btnSimpan.Click
		...
		If SimpanWebtoon(id, txtJudul.Text, cmbGenre.Text, txtAuthor.Text, numRating.Value, cmbStatus.Text) Then
	...
	Private Sub btnUbah_Click(sender As Object, e As EventArgs) Handles btnUbah.Click
		...
		If UbahWebtoon(id, txtJudul.Text, cmbGenre.Text, txtAuthor.Text, numRating.Value, cmbStatus.Text) Then
