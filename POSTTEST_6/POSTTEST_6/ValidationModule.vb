Module ValidationModule
    ...
    ' (Tambahan biar lebih rapi, opsional tapi bagus)
    ...
    ' =========================
    ' VALIDASI GENRE (FORM3)
    ' =========================
    Public Function ValidasiGenre(ep As ErrorProvider, txtKodeGenre As TextBox, txtGenre As TextBox) As Boolean

        Dim kodeValid As Boolean = ValidasiTextBox(ep, txtKodeGenre, "Kode Genre tidak boleh kosong")
        Dim genreValid As Boolean = ValidasiTextBox(ep, txtGenre, "Nama Genre tidak boleh kosong")

        Return kodeValid And genreValid
    End Function

    ' =========================
    ' VALIDASI WEBTOON (PUNYAMU - TETAP DIPAKAI)
    ' =========================
